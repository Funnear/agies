...
export default function SpotifyReduxApp() {
...
Contact: booking@${artistName.toLowerCase().replace(/\s+/g, "")}-official.com`;
  ...
  const dispatchBooking = () => {
    dispatch(
      setInquiryReceipt(
        `✓ Formal Booking Offer of ${inquiryFee} EUR for ${inquiryDate} transmitted to ${selectedVenue.name} Booking Dept (Redux Store Dispatched). Status: DISPATCHED_TO_AGENT.`
      )
    );
  };
        ...
        <aside className="w-64 bg-[#121212] rounded-lg flex flex-col gap-2 p-4 shrink-0 border border-white/5 shadow-2xl">
          ...
          <div className="flex items-center gap-2 px-2 py-1 text-white">
            ...
            <div className="font-bold text-lg tracking-tight text-white flex items-center gap-1.5">
              AGIES{" "}
              <span className="text-[10px] text-[#1DB954] font-mono px-1.5 py-0.5 rounded bg-[#1DB954]/10 border border-[#1DB954]/30">
                REDUX
              </span>
            </div>
          </div>
          ...
          <div className="space-y-1 mt-2">
            ...
            <button
              ...
              className={`w-full flex items-center gap-4 px-3 py-2.5 rounded-md font-semibold text-sm transition-all ${
                activeNav === "studio"
                  ? "text-white bg-white/10 text-[#1DB954]"
                  : "hover:text-white"
              }`}
            >
            ...
            <div className="overflow-y-auto space-y-1 pr-1 flex-1 text-xs">
              {[
                ...
                { title: "Ostgut Ton", sub: "Label • Techno Landmark" },
                {
                  ...
                  sub: "A&R Showcase • 90%+ Scout Density",
                },
              ].map((item, idx) => (
                <div
                  key={idx}
          ...
          <div className="sticky top-0 bg-[#121212]/80 backdrop-blur-xl z-30 px-6 py-3.5 flex items-center justify-between border-b border-white/5">
            <div className="flex items-center gap-3">
              <span className="text-xs font-mono text-white/50 bg-black/40 px-3 py-1.5 rounded-full border border-white/10 flex items-center gap-2">
                ...
                FASTAPI :8000 • REDUX TOOLKIT ACTIVE • 507 NODES
              </span>
            </div>
            <div className="flex items-center gap-3">
              <button
                ...
                <div className="rounded-xl p-8 bg-gradient-to-br from-[#1e3a8a] via-[#0f172a] to-[#121212] border border-blue-500/20 relative overflow-hidden shadow-2xl">
                  <div className="max-w-2xl relative z-10 space-y-4">
                    <span className="px-3 py-1 bg-[#1DB954]/20 border border-[#1DB954]/40 text-[#1DB954] rounded-full text-xs font-mono font-bold">
                      REACT • TYPESCRIPT • REDUX • THREE.JS
                    </span>
                    <h1 className="text-4xl font-extrabold text-white tracking-tight leading-tight">
                      Take Your Bedroom Tracks to Global Stages
                    </h1>
                    <p className="text-sm text-[#b3b3b3] leading-relaxed">
                      Powered by the <b>arXiv:2110.08862 Mel-Spectrogram & Tempogram Classifier</b>, Redux Toolkit state synchronization, and a 507-node Global Music Industry Graph.
                    </p>
                ...
                <div>
                  <div className="flex justify-between items-center mb-4">
                    <h2 className="text-xl font-bold text-white tracking-tight">
                      Nearest Acoustic Titans (arXiv:2110.08862)
                    </h2>
                  </div>
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                    {[
                      ...
                      },
                      {
                        ...
                        score: "89.7%",
                        img: "https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=300&q=80",
                      },
                    ].map((item, idx) => (
                      <div
                        key={idx}
                      ...
                      >
                        <div className="relative mb-3 aspect-square rounded-md overflow-hidden bg-black/40">
                          ...
                          <button
                            ...
                            className="absolute bottom-2 right-2 w-10 h-10 rounded-full bg-[#1DB954] shadow-xl flex items-center justify-center opacity-0 group-hover:opacity-100 group-hover:translate-y-0 translate-y-2 transition-all duration-200"
                          >
                        ...
                        <div className="text-[11px] font-mono text-[#1DB954] font-bold mt-2">
                          {item.score} ACOUSTIC MATCH
                        </div>
                      </div>
                    ))}
                  </div>
                    ...
                    <div className="space-y-3 text-xs">
                      ...
                      >
                        ...
                        {isDiagnosing
                          ...
                          : "Run Redux AI Diagnostic & Benchmark"}
                      </button>
                    </div>
                  </div>
                    ...
                    <div className="space-y-2.5 text-xs">
                      <div className="p-3 bg-black/40 border-l-2 border-[#1DB954] rounded-r-md">
                        <div className="font-bold text-white mb-0.5">
                          Phase 1: Production & Direct-to-Fan
                        </div>
                        <div className="text-[#b3b3b3]">
                          Master 3-track EP. Sell lossless downloads directly via Bandcamp + DistroKid DSP delivery.
                        </div>
                      </div>
                      <div className="p-3 bg-black/40 border-l-2 border-[#1DB954] rounded-r-md">
                        <div className="font-bold text-white mb-0.5">
                        ...
                        <div className="text-[#b3b3b3]">
                          Submit stems to COLORS, Boiler Room, and HATE. Register with GEMA / SoundExchange.
                        </div>
                      </div>
                      <div className="p-3 bg-black/40 border-l-2 border-[#1DB954] rounded-r-md">
                        <div className="font-bold text-white mb-0.5">
                          Phase 3: Showcase Circuits
                        </div>
                        <div className="text-[#b3b3b3]">
                          Apply for Reeperbahn Festival / ESNS open calls to perform for international A&R scouts.
                        </div>
                      </div>
                      <div className="p-3 bg-black/40 border-l-2 border-[#1DB954] rounded-r-md">
                        <div className="font-bold text-white mb-0.5">
                          Phase 4: Boutique Label Leverage
                        </div>
                        <div className="text-[#b3b3b3]">
                          Retain 100% publishing rights. Negotiate single-EP licensing deal with a maximum 3-year term.
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-[#181818] rounded-xl p-6 border border-white/5 space-y-4">
                  ...
                  <div className="space-y-2 text-xs">
                    {[
                      ...
                      <div
                        key={idx}
                        className="p-3 bg-black/40 rounded-lg flex justify-between items-center"
                      >
                        <div>
        ...
        {showRightDrawer && (
          <aside className="w-72 bg-[#121212] rounded-lg p-4 flex flex-col gap-4 shrink-0 border border-white/5 shadow-2xl overflow-y-auto text-xs">
            ...
            <div className="p-3 bg-[#181818] rounded-lg border border-white/5 space-y-1.5">
              ...
              <div className="text-[11px] text-white/50">
                Rights:{" "}
                <span className="text-[#1DB954]">100% Artist Owned</span>
              </div>
              <div className="text-[11px] text-white/50">
